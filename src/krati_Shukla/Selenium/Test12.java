//emplyee count in each deptName

//count number of employee under each manager.
...
public class Test12 {
	...
	static void countManagerEmp(WebDriver driver) throws InterruptedException {
		...
		for (int index=0; index<size; index++) {
			String manager = driver.findElement(By.xpath("//table[@class='table table-striped']//tbody//tr["+(index+1)+"]//td[4]")).getText();
