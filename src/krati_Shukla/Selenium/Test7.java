...
public class Test7 {
	...
	static ArrayList<String> getLastName(WebDriver driver) throws InterruptedException {
		// rows and cols are dynamic, get the lastname of the emp whoes firstname is
		// "Abhishek".
		driver.findElement(By.id("demotable")).click();
		Thread.sleep(5000);
		ArrayList<String> list = new ArrayList<String>();
		List<WebElement> lastName = driver.findElements(By.xpath("//table[@id='table1']//td[text()='Abhishek']//following::td[1]"));
