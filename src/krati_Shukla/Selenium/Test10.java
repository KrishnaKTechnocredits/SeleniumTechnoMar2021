...
public class Test10 {
	...
	static void getLastName(WebDriver driver) throws InterruptedException {
		...
		for(int index=0; index<countSize; index++) {
			WebElement fName = driver.findElement(By.xpath("//table[@id='table1']//tbody//tr["+(index+1)+"]//td[2]"));
			String firstName = fName.getText();
			System.out.println("First Name is :"+firstName);
			if(firstName.equals("Maulik")) {
				WebElement lName = driver.findElement(By.xpath("//table[@id='table1']//tbody//tr["+(index+1)+"]//td[3]"));
				WebElement userName = driver.findElement(By.xpath("//table[@id='table1']//tbody//tr["+(index+1)+"]//td[4]"));
