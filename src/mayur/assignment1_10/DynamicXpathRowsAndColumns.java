...
public class DynamicXpathRowsAndColumns {
	...
	public static String getRequiredColumnValue(WebDriver driver, String key, String fName, String columnNeeded) {
		...
		String value = driver.findElement(By.xpath("//table[@id='table1']//tr/td[" + keyIndex + "][text()='" + fName
				+ "']//ancestor::tr/td[" + colIndex + "]")).getText();
		return value;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("For column " + key + " with value as " + fName + " Column " + columnNeeded + " value is "
				+ getRequiredColumnValue(driver, key, fName, columnNeeded));
