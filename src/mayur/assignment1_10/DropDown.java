...
public class DropDown {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println(
				"SECOND and THIRD PS - Select option 2 & 3 & 4 and find selected count and display them *****");
		...
		System.out.println(finalList.get(finalList.size() - 2).getText() + " Selected status : "
				+ finalList.get(finalList.size() - 2).isSelected());
		Thread.sleep(3000);
		driver.close();
	}
}