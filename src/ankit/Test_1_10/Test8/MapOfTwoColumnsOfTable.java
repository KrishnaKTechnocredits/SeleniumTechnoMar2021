...
public class MapOfTwoColumnsOfTable {
	...
	private static int getIndexOfColumn(WebDriver driver, String colName) {
		...
		List<WebElement> headerList = driver.findElements(By.xpath("//table[@class='table table-striped']/thead/tr/th"));
	...
	public static HashMap<String, String> getHashMapOfSelectedColumns(WebDriver driver, String col1, String col2) {
		...
		for(int index = 1; index <= totalRows; index++) {
			String key = driver.findElement(By.xpath("//table[@class='table table-striped']/tbody/tr["+index+"]/td["+col1Index+"]")).getText();
			String value = driver.findElement(By.xpath("//table[@class='table table-striped']/tbody/tr["+index+"]/td["+col2Index+"]")).getText();
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter two columns you need in HashMap (ex: #,Employee Id,Employee Name,Employee ManagerID,Employee Department):");
